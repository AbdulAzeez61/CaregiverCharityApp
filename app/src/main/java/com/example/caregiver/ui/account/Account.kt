    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.devcAccount.setOnClickListener {
            user?.delete()?.addOnSuccessListener {
                ...
                Toast.makeText(this, "An error occurred while deleting your account", Toast.LENGTH_SHORT).show()
            }
        }
                    ...
                    user?.updateProfile(profileUpdates)
                        ?.addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                Toast.makeText(this, "profile img successfully setup", Toast.LENGTH_SHORT).show()
            ...
            uploadTask.addOnSuccessListener {
                ...
                imageRef.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    user?.updateProfile(profileUpdates)
                        ?.addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                Toast.makeText(this, "Profile image successfully set up", Toast.LENGTH_SHORT).show()
                                Glide.with(this).load(uri).into(binding.profileImg)
                            } else {
                                Toast.makeText(this, "Profile image setup failed", Toast.LENGTH_SHORT).show()
                            }
                        }
                }.addOnFailureListener {
